  ...
  return (
    <>
      ...
      <div className="mx-12 pt-8 text-justify">
        ...
        <p className="mb-4">
          Usted acepta utilizar nuestro sitio web únicamente con fines legales y
          de acuerdo con estos términos y condiciones. Usted acepta no utilizar
          nuestro sitio web para fines ilegales o no autorizados y se compromete
          a cumplir con todas las leyes y regulaciones aplicables.
        </p>
        <h2 className="text-lg font-bold mb-4">Propiedad intelectual</h2>
        <p className="mb-4">
        ...
        <p className="mb-4">
          Podemos actualizar estos términos y condiciones de vez en cuando. Le
          recomendamos que revise periódicamente esta página para estar
          informado acerca de cualquier cambio en nuestros términos y
          condiciones.
        </p>
